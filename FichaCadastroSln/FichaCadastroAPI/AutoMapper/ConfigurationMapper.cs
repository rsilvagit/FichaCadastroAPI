    ...
    public class ConfigurationMapper : Profile
    {
        public ConfigurationMapper()
        {
            ...
            CreateMap<FichaCreateDTO, FichaModel>()
                .ForMember(destino => destino.Nome, origem => origem.MapFrom(dados => dados.Nome))
                .ForMember(destino => destino.Email, origem => origem.MapFrom(dados => dados.Email.ToLower()))// método ToLower garante que os o email sera registrado em letras minusculas mesmo que o usuario informe em letras maiusculas
                .ForMember(destino => destino.DataNascimento, origem => origem.MapFrom(dados => dados.DataNascimento));
            //origem ...destino
